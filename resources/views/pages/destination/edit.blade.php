...
@section('content')
    <main class="w-full">
        <x-breadcrumb homeLink="destinations" homeTitle="Destinations" currentLink="#" currentTitle="Edit" />
        <x-page-header title="destinations" buttonText="Edit Destination" :buttonAvailable=false />
            ...
            <form method="POST" action="{{ route('destinations.update', $destination->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <textarea id="description" name="description" rows="10"
                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ old('description', $destination->description) }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input
                        ...
                        id="dropzone-file" type="file" name="img" onchange="previewImage(event)">
